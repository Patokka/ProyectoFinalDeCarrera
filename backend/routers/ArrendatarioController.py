...
def crear_arrendatario(dto: ArrendatarioDto, db: Session = Depends(get_db)):
...
def actualizar_arrendatario(arrendatario_id: int, dto: ArrendatarioDtoModificacion, db: Session = Depends(get_db)):
...
def eliminar_arrendatario(arrendatario_id: int, db: Session = Depends(get_db)):
