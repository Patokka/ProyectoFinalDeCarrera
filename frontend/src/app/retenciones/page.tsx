...
const retencionesData: RetencionDtoOut[] = [
  {
    id: 1,
    fecha_retencion: '2025-09-20',
    monto_imponible: 59999999,
    total_retencion: 59999999,
    arrendador: {
      id: 1,
      nombre_o_razon_social: 'Arrendador Ejemplo',
      cuil: '20-12345678-9',
    ...
    facturacion: {
      id: 3,
      fecha_facturacion: '2025-09-21',
      tipo_factura: 'A',
      monto_facturacion: 100000,
      arrendador: {} as any,
      pago: {} as any
    }
  },
  {
    ...
    facturacion: {
      id: 4,
      fecha_facturacion: '2025-09-20',
      tipo_factura: 'A',
      monto_facturacion: 120000,
      arrendador: {} as any,
      pago: {} as any
    }
  },
...
export default function RetencionesPage() {
  const [retenciones, setRetenciones] = useState<RetencionDtoOut[]>(retencionesData);
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-slate-100 rounded-lg shadow-sm border border-gray-400 p-6 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <SearchInput
              placeholder="ej: Arrendador Ejemplo"
