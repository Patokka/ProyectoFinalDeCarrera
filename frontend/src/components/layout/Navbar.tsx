          ...
          <div className="flex justify-between items-center h-16">
            <Link href="/" className="flex items-center space-x-2">
              <div className="w-20 h-10 bg-white rounded-lg flex items-center justify-center">
                <img src="/logo2.png" alt="Avatar" className="w-10 h-10 rounded-lg object-cover"/>
              </div>
            ...
            <div className="hidden lg:flex items-center space-x-4">
              <Link href = {`/usuarios/${user.id}`} passHref> 
                <div className="flex items-center space-x-3 px-3 py-1 bg-gray-300 rounded-lg hover:bg-green-400">
        ...
        {isMobileMenuOpen && (
          <div className="lg:hidden border-t border-gray-200 bg-white">
            ...
            <div className="border-t border-gray-200 pt-3 mt-3">
              <Link href = {`/usuarios/${user.id}`} passHref> 
                <div className="flex items-center space-x-3 px-3 py-2 w-full text-left text-base font-medium text-gray-700 hover:text-green-600 hover:bg-green-50 rounded-md">
                  <User  />
